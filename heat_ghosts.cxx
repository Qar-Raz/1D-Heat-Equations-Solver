...
public:
  ...
  Worker(Worker&& w) : num(w.num), lo(w.lo), hi(w.hi), sz(w.sz), data(w.data), data2(w.data2), leftThread(w.leftThread), rightThread(w.rightThread) {}
...
int main(int argc, char **argv) {
  // No longer need command line arguments or assertion
